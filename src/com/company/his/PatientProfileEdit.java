...
public class PatientProfileEdit extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		save.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				MainActivity.db.execSQL("UPDATE patient SET patientID='"+ user +"',password='"+ password +"',firstname='"+ firstname +"',lastname='"+ lastname +"',age='"+ age +"',phone='"+ phone +"',email='"+ email +"' WHERE patientID= '"+ user +"'");
